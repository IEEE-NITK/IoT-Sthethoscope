...
fo, to, Sxxo = signal.spectrogram(data,fs=sampleRate,nfft=512,nperseg=512)
fig = plt.figure()
...
sos = signal.butter(100, [100,5000], btype='bandpass', analog=False, output='sos', fs=sampleRate)
...
ff, tf, Sxxf = signal.spectrogram(y)
